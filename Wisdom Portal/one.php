...
<html>
<head>
	<title>Книга мудрости - высказывания, афоризмы
	</title>
	...
	<div class="back">
		<div class="main">
				<div class="logo">
					...
					<div class="title">	<span class="big"><b>Книга мудрости</b></span><br><span class="small"><i>Вся мудрость древности и современности - здесь!</i></span>
                    </div>
                    <div class='top_sel'>
                    <a class='und' href='#'></a>
                    </div>
                ...
                <div id='upsided'>
                    ...
                    <div class="cover" style='display:none'>
                        <div id='close'><img src='cross.png'>
                        </div>
                        <div id='authors'>
...
(adsbygoogle = window.adsbygoogle || []).push({});
                    ...
                    <div id='r_block'>
                        ...
                        <div id='r_block_cont'>
                            <strong><? echo $auth_name." высказывания о жизни, любви, семье<br>".$auth_name." история, биография<br>".$auth_name."  философия<br>"."Философ ".$auth_name." цитаты" ?>, великие высказывания</strong>
                        </div>
                    </div>
                </div>
